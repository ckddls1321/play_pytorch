...
def get_annotations_wider_txt(fname, prefix=None):
    ...
    ids = list(id2images.key())
    return [id2images[k] for k in ids], [[id2bboxes[k], id2cats[k]] for k in ids]


def widerface(data_root='', batch_size=32, imgsize=256, **kwargs):
    wider_path = Path(data_root + 'widerface')
    ...
    data = (ObjectItemList.from_folder(wider_path, recurse=True)
